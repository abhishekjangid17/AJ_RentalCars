...
import CarImg1 from "../images/img2/15.jpg";
import CarImg2 from "../images/img2/bmwm32.jpg";
import CarImg3 from "../images/img2/hilux.jpeg";
              ...
              <div className="models-div__box__img">
                ...
                <div className="models-div__box__descr">
                  ...
                  <div className="models-div__box__descr__name-price__details">
                    <span>
                      <i className="fa-solid fa-car-side"></i> &nbsp; Porsche
                    </span>
                    <span style={{ textAlign: "right" }}>
                      2/5 &nbsp; <i className="fa-solid fa-car-side"></i>
                    </span>
                    <span>
            ...
            <div className="models-div__box">
              <div className="models-div__box__img">
                ...
                <div className="models-div__box__descr">
                  ...
                  <div className="models-div__box__descr__name-price__details">
                    <span>
                      <i className="fa-solid fa-car-side"></i> &nbsp; Hilux 4x4
                    </span>
                    <span style={{ textAlign: "right" }}>
